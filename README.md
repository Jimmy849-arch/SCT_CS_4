...
⚠️ EDUCATIONAL KEYLOGGER (Cybersecurity Learning Tool Only) ⚠️ Disclaimer (Read First!)

This project is strictly for educational and cybersecurity learning purposes. A keylogger can record every key a user types—including passwords, messages, and sensitive data.

❗ Using a keylogger on any device you do not own or do not have explicit written permission to test is illegal. ❗ Distributing, deploying, or running this program on someone else’s computer is a criminal offense in many countries. ❗ This is provided ONLY to help students understand how monitoring tools work in cybersecurity.
...
🚫 Not for real-world deployment 🚫 Not for monitoring others 🚫 Not for penetration testing without authorization
